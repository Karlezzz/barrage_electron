        ...
        <div class="signin-signup">
          ...
          <form action="#" class="sign-in-form">
            ...
            <div class="input-filed moreRoomName">
              ...
              <div class="img" @click="showRoomNameList">
                <img src="../Enter/image/下拉.png" alt="">
              </div>
              <!-- 房间信息列表 -->
              <div class="roomIdList" v-if="isShowRoomName">
                <div class="listItem" v-for="item in roomInfoList" :key="item.roomId" @click="selectRoomName(item)">
                  {{item.roomName}}</div>
              </div>
            </div>
            <!-- 房间id -->
