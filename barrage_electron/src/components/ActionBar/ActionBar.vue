<template>
	<div class="bc">
		<div class="browserAction">
			...
			>
				<img
					src="../../static/image/窗口-窗口化_line.png"
					alt=""
				/>
			</div>
			<div
			...
			>
				...
				<div class="box">
					<input
						...
						:value="one"
						id="one"
					/><label for="one">Quit</label>
				</div>
			</div>
			<div class="button">
				<button @click="selectClose">Confirm</button>
			</div>
		</div>
	</div>
</template>
